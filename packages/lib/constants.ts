...
import packageConfig from "@calcom/web/package.json";
...
export const WEBAPP_URL_FOR_OAUTH = IS_PRODUCTION ? WEBAPP_URL : "http://localhost:3001";
...
export const OG_IMAGE = `${CAL_URL}/oh-logo-word.svg`;
...
export const CALCOM_VERSION = process.env.NEXT_PUBLIC_CALCOM_VERSION ?? packageConfig.version;
...
export const WHITELISTED_ORGS = process.env.NEXT_PUBLIC_WHITELISTED_ORGS;
export const IS_APPLE_LOGIN_ENABLED = process.env.AUTH_APPLE_ID && process.env.AUTH_APPLE_SECRET;
export const IS_GITHUB_LOGIN_ENABLED = process.env.GITHUB_CLIENT_ID && process.env.GITHUB_CLIENT_SECRET;
