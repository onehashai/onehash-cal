              ...
              {props.CTA && (
                <div
                  className={classNames(
                    props.backPath
                      ? "relative"
                      : "pwa:bottom-[max(7rem,_calc(5srem_+_env(safe-area-inset-bottom)))] fixed bottom-[5.2rem] z-40 ltr:right-[6rem] rtl:left-4 md:z-auto md:ltr:right-0 md:rtl:left-0",
