      ...
      <div className="max-h-[390px] overflow-scroll">
        {slots.map((slot) => (
          <div key={slot.time.format()} className="flex flex-row items-center ">
            <a
              className="border-brand-default text-bookingdarker bg-default  mb-2 mr-3 block min-w-48 flex-grow rounded-md border py-2 text-center font-medium dark:border-transparent dark:bg-gray-600 "
              data-testid="time">
