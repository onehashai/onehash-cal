...
const Member = ({ member, teamName }: { member: MemberType; teamName: string | null }) => {
  ...
  return (
    <Link
      ...
      <div className="bg-default hover:bg-muted border-subtle sm:min-w-80 sm:max-w-80 group flex min-h-full flex-col space-y-2 rounded-md border p-4 transition hover:cursor-pointer">
